...
export const roadmap: RoadmapItem[] = [
  {
    ...
    body: "The core loop, on every machine running the stable build: hold a key, talk, get clean text in any app — with transcription and cleanup both running on your own Mac.",
    state: "shipping",
    bullets: [
  ...
  {
    phase: "1.1 · beta",
    title: "The assistant, and what it can reach",
    body: "Hold fn + control instead of the dictation key and the same voice files a note, sets a reminder, or asks a question of the tools you've connected. Live on the beta channel now, and deliberately dark on stable until it has been proven there.",
    state: "building",
    bullets: [
  ...
  {
    phase: "1.1 · dev",
    title: "A coding agent in the notch",
    body: "The notch already takes your voice and shows you an answer, so pointing it at an agent already running on your Mac costs almost nothing. Start a turn by talking, watch the tool calls land, and answer a permission ask without leaving the app you're in.",
    state: "building",
    bullets: [
  ...
  },
  {
    ...
    body: "The evaluation engine says clean speech is solved at 3.4% word error rate, and that noise and the audio Bluetooth serves up in call mode are the real bottlenecks. Those numbers have not moved yet, so they stay here.",
    state: "building",
    bullets: [
  ...
  },
  {
    ...
    body: "Dictation is the entry point, not the destination. The same local pipeline that hears a sentence can capture a meeting — and then let you ask questions about the whole of it.",
    state: "next",
    bullets: [
